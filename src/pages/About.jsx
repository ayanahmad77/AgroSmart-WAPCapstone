...
const techStack = [
  ...
  { icon: <Database size={20} />, name: 'Tailwind CSS', desc: 'Utility-first styling', color: '#a78bfa' },
  { icon: <Leaf size={20} />, name: 'Lucide Icons', desc: 'Clean icon library', color: '#fbbf24' },
]

export default function About() {
  return (
    <div className="page-wrapper pt-28 pb-20 px-6">
